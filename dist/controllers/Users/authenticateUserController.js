...
var authenticateUserService_1 = require("../../services/Users/authenticateUserService");
var AuthenticateUserController = /** @class */ (function () {
    ...
    AuthenticateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, authenticateUserService, tokenJwt, responseJwt;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, response.json(responseJwt)];
                }
            });
        });
    };
