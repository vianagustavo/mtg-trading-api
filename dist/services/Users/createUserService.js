...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, loginPassword = _a.loginPassword;
        return __awaiter(this, void 0, void 0, function () {
            var emailExists, passwordHash, user, password, newUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        emailExists = _b.sent();
                        if (emailExists) {
                            throw new error_1.InvalidArgument("Email is already in use.");
                        }
                        return [4 /*yield*/, (0, bcryptjs_1.hash)(loginPassword, 10)];
                    case 2:
                    ...
                    case 3:
                        user = _b.sent();
                        password = user.password, newUser = __rest(user, ["password"]);
